...
def delineate_Watershed_atShapeFile(input_DEM_raster, input_outlet_shapefile,
                                    output_raster, output_outlet_shapefile,stream_threshold):
    """TauDEM doesn't take compressed file; uncompress file
        ToDO:  Check compression first"""
    temp_raster = input_DEM_raster #  'temp.tif'
...
def uncompressRaster(input_raster, output_raster):
    ...
    return call_subprocess(cmdString, input_raster)#'uncompress raster')
